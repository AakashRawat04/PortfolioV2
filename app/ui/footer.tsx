...
export default function Footer() {
	return (
		<>
			<footer className="flex flex-col border-t-2 border-neutral-900 items-center justify-center w-full p-3">
				<div className="mx-auto max-w-screen-xl px-4 py-5 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-3xl space-y-6">
						<div className="flex justify-center gap-6">
							<a
								className="text-neon-green hover:text-neon-green/75"
								href="https://twitter.com/rawatAsh2004"
								target="_blank"
								rel="noreferrer"
								aria-label="Twitter"
							>
							...
							<a
								className="text-neon-green hover:text-neon-green/75"
								href="https://www.linkedin.com/in/aakashrawatt/"
								target="_blank"
								rel="noreferrer"
								aria-label="LinkedIn"
							>
							...
							<a
								className="text-neon-green hover:text-neon-green/75"
								href="mailto:01tripster@gmail.com"
								target="_blank"
								rel="noreferrer"
								aria-label="Dribbble"
							>
